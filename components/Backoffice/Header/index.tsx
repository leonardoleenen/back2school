...
const Header = (): JSX.Element => {
    ...
    const Absents = ({ selected }) => {
        return (
            <div
                onClick={() => router.push('/backoffice/bi/absents')}
                className={`flex ml-8 items-center cursor-pointer ${
                    selected ? 'text-blue-500 font-semibold' : 'text-gray-500'
                }`}
            >
                ...
                <div className="ml-2">Absents</div>
            </div>
        )
    }
    ...
    const Reports = ({ selected }) => {
        return (
            <div
                onClick={() => router.push('/backoffice/bi/reports')}
                className={`flex ml-8 items-center cursor-pointer ${
                    selected ? 'text-blue-500 font-semibold' : 'text-gray-500'
                }`}
            >
        ...
        <div className={styles.backofficeHeader}>
            <div className="flex">
                ...
                <Space size="large">
                    ...
                    <Absents selected={selectedTab === 'ABSENT'} />
                    <Reports selected={selectedTab === 'REPORT'} />
                </Space>
            </div>
